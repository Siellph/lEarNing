...
B1 = [
    module(
        ...
        24,
        "Уже произошло — но где якорь времени",
        lesson(
            "Оба времени смотрят в прошлое, но якоря разные. Present Perfect держит связь с настоящим: опыт, результат, незакрытый отрезок (today, this week, since, for). Past Simple кладёт событие в закрытый отрезок: yesterday, last March, in 2016, when I was a child. Русское «я жил / я живу здесь уже…» нужно развилкать: закончилось — Past Simple; всё ещё длится — Present Perfect.",
            [
                rule(
                    "Present Perfect: период ещё жив",
        ...
        [
            fill("I ___ my keys — I can't open the door. (lose)", "have lost", "Результат сейчас — Present Perfect.", ["I've lost"]),
            mc("___ you see the eclipse in 2024?", ["Have", "Did", "Has"], "Did", "2024 как закрытая дата — Past Simple, Did + V1."),
            ...
            xf("Past Simple: She has already called the clinic. Add last Tuesday.", "She called the clinic last Tuesday.", "Точная дата вытесняет Present Perfect."),
            fill("How long ___ you ___ this phone? (have, всё ещё ваш)", "have / had", "How long + Present Perfect of have.", ["have had"]),
            mc("I ___ to the new gallery; I came back an hour ago.", ["have gone", "have been", "had gone"], "have been", "Been = съездил и вернулся."),
        ],
    ),
    module(
        ...
        [
            fill("He ___ overtime all week. (work)", "has been working", "All week + процесс, he + has.", ["he's been working"]),
            mc("Sorry about the mess. I ___ the shelves.", ["have painted", "have been painting", "painted yesterday"], "have been painting", "След деятельности важнее законченного результата."),
            ...
            fill("How many pages ___ you ___ today? (write)", "have / written", "How many + результат — Perfect Simple.", ["have written"]),
            mc("It ___ since noon, and the pitch is flooded.", ["has rained", "has been raining", "rains"], "has been raining", "Длящийся процесс с видимым следствием."),
        ],
    ),
    module(
        "past-perfect",
        ...
        [
            fill("He couldn't get in because he ___ his pass. (forget)", "had forgotten", "Forget — forgot — forgotten."),
            mc("The kettle clicked: the water ___ already.", ["boiled", "had boiled", "has boiled"], "had boiled", "Кипение завершилось до щелчка — Past Perfect."),
            ...
            fill("___ you packed before the taxi came?", "Had", "Вопрос Past Perfect — Had + подлежащее."),
            mc("The streets were wet. It ___ earlier.", ["rained", "had rained", "has rained"], "had rained", "Дождь раньше наблюдаемого прошлого."),
        ],
    ),
    module(
        "future-continuous",
        ...
        [
            fill("This time next week she ___ in Lisbon. (land, процесс поездки: fly)", "will be flying", "This time next week — классический маркер.", ["she'll be flying"]),
            mc("Will you ___ late again on Friday?", ["be working", "working", "to work"], "be working", "Will you be + V-ing."),
            ...
            fill("We ___ emails all morning, so replies may be slow. (answer)", "will be answering", "Длительный будущий процесс.", ["we'll be answering"]),
            mc("I ___ you at the kiosk at 5. (договорённость-факт)", ["will be meeting", "will meet", "meet will"], "will meet", "Простая договорённость — will + V1."),
        ],
    ),
    module(
        "second-conditional",
        ...
        [
            ...
            xf("Second: I don't have a balcony. I don't grow tomatoes.", "If I had a balcony, I would grow tomatoes.", "If + Past, would + V1.", ["If I had a balcony, I'd grow tomatoes"]),
        ...
        [
            fill("If they ___ fewer clients, they could leave at six. (have)", "had", "If + Past; have → had."),
            mc("I ___ join you if I didn't have a rehearsal.", ["will", "would", "would to"], "would", "Would + V1."),
            ...
            fill("If I ___ nearer, I'd walk. (not live)", "didn't live", "If + Past negative.", ["did not live"]),
            mc("If you heated the chocolate, it ___ . (факт всегда)", ["would melt", "melts", "melted"], "melts", "Всегда правда — Zero, не Second."),
        ],
    ),
    module(
        "third-conditional",
        ...
        [
            ...
            xf("Third: I didn't save the draft. I lost the chapter.", "If I had saved the draft, I wouldn't have lost the chapter.", "If + had + V3, wouldn't have + V3.", ["If I had saved the draft, I would not have lost the chapter"]),
        ...
        [
            fill("We would have hired her if she ___ the trial task. (finish)", "had finished", "If + had + V3."),
            mc("If they had left a key, we ___ in.", ["could have got", "could get", "can have got"], "could have got", "Could have + V3 — упущенная возможность."),
            ...
            fill("If I ___ hungry, I would have ordered dessert. (not be)", "hadn't been", "If + hadn't + V3 (been).", ["had not been"]),
            mc("If I ___ more time tomorrow, I would help. (гипотеза о будущем)", ["had had", "had", "would have"], "had", "Завтра + нереально сейчас — Second, не Third."),
        ],
    ),
    module(
        "modals-possibility",
        ...
        [
            fill("That painting ___ have cost a fortune. (сильный вывод о прошлом)", "must", "Must have + V3; have уже в предложении."),
            mc("She ___ be in Prague — she posted a story from the office five minutes ago.", ["must", "can't", "might not to"], "can't", "Факт ломает гипотезу."),
            ...
            fill("We ___ have taken the wrong exit — nothing looks familiar. (вывод о прошлом)", "must", "Must have + V3.", ["might"]),
            mc("You ___ tell anyone — it's confidential. (запрет, не вывод)", ["can't have", "mustn't", "might not be"], "mustn't", "Confidential = запрет, mustn't."),
        ],
    ),
    module(
        "reported-statements",
        ...
        [
            ...
            mc("'I am tired.' → He said he ___ tired.", ["is", "was", "had been"], "was", "Present Simple → Past Simple."),
        ...
        [
            fill("'I bought this yesterday.' → He said he had bought that ___.", "the day before", "Yesterday → the day before.", ["the previous day"]),
            mc("She ___ that the lift was broken.", ["told", "said", "told to"], "said", "Said that без обязательного адресата."),
            err("He told that he was late.", "He said that he was late.", "Told без адресата нельзя.", ["He told me that he was late"]),
            xf("'I don't like fennel.' → She said…", "She said she didn't like fennel.", "Don't → didn't.", ["She said that she didn't like fennel", "She said she did not like fennel"]),
            fill("'We're meeting here.' → They said they were meeting ___.", "there", "Here → there."),
            mc("'I must leave at 5.' → He said he ___ leave at 5.", ["must to", "had to", "have to"], "had to", "Must обязанности часто → had to."),
        ],
    ),
    module(
        "reported-questions",
        ...
        [
            ...
            xf("'Can you swim?' → He asked… (me)", "He asked me if I could swim.", "Can → could, if + прямой порядок.", ["He asked me whether I could swim"]),
        ...
        [
            fill("'Have you seen my pass?' → He asked if I ___ his pass.", "had seen", "Present Perfect → Past Perfect."),
            mc("'Who took the parcel?' → She asked who ___ the parcel.", ["did take", "had taken", "has taken"], "had taken", "Past Simple часто → Past Perfect в репортаже."),
            err("He asked what did I mean.", "He asked what I meant.", "Без did, порядок S + V."),
            xf("'Why are you laughing?' → She asked…", "She asked why I was laughing.", "Present Continuous → Past Continuous.", ["She asked why I was laughing."]),
            fill("The tourist asked how ___ get to the station. (инфинитив)", "to", "How to + V1."),
            mc("They asked me ___ wait outside.", ["if", "to", "that"], "to", "Ask someone to + V — просьба."),
        ],
    ),
    module(
        "passive-all-simple",
        ...
        [
            fill("Two windows ___ broken in the storm. (be, past)", "were", "Past Simple Passive, множественное."),
            mc("A decision ___ yet.", ["hasn't been made", "hasn't made", "wasn't been made"], "hasn't been made", "Present Perfect Passive negative."),
            ...
            fill("Applications should ___ submitted by Friday.", "be", "Modal + be + V3."),
            mc("English ___ in this office.", ["speaks", "is spoken", "has spoken"], "is spoken", "Present Simple Passive."),
        ],
    ),
    module(
        ...
        [
            fill("Our landlord, ___ is away in June, left us a spare key.", "who", "Известное лицо + запятые — who."),
            mc("The tram ___ goes to the harbour is packed at 8.", [", which", "which", ", that"], "which", "Defining без запятых; which/that оба возможны, из вариантов — which без запятой."),
            ...
            xf("Defining: That's the café. We found the cat there.", "That's the café where we found the cat.", "Where в defining.", ["That is the café where we found the cat"]),
            fill("The annex, which ___ rebuilt in 2019, now holds the archive. (be, past passive)", "was", "Non-defining + Past Passive."),
            mc("You cannot use ___ in a non-defining clause.", ["which", "who", "that"], "that", "That в non-defining не ставят."),
        ],
    ),
    module(
        ...
        [
            fill("She promised ___ after 10. (not call)", "not to call", "Promise + not to + V1."),
            mc("I stopped ___ a sandwich and then continued walking.", ["eating", "to eat", "eat"], "to eat", "Остановился, чтобы поесть."),
            ...
            fill("It's important ___ the date. (check)", "to check", "Прилагательное + to."),
            mc("I remember ___ her at the harbour in 2019.", ["to meet", "meeting", "meet"], "meeting", "Помню сам факт встречи — remember + -ing."),
        ],
    ),
    module(
        "wish-past-simple",
        ...
        [
            fill("She wishes she ___ nearer the river. (live)", "lived", "Wish + Past Simple, 3-е лицо wishes."),
            mc("I wish I ___ stay, but the last bus is at 10.", ["can", "could", "would can"], "could", "Нет возможности сейчас."),
            ...
            fill("I wish we ___ to rush. (not have)", "didn't have", "Wish + Past negative.", ["did not have"]),
            mc("I wish I ___ that email yesterday. (это уже прошлое — маркер уровня)", ["didn't send", "hadn't sent", "wouldn't send"], "hadn't sent", "Закрытое вчера — wish + Past Perfect, не Past Simple."),
        ],
    ),
    module(
        "question-tags",
        ...
        [
            fill("They haven't billed us, ___ they?", "have", "Отрицание have → положительный хвост."),
            mc("There is a spare key, ___ ?", ["isn't it", "isn't there", "aren't there"], "isn't there", "There is → isn't there."),
            ...
            fill("We should leave a tip, ___ we?", "shouldn't", "Should → shouldn't."),
            mc("Nobody called back, ___ they?", ["did", "didn't", "do"], "did", "Nobody — отрицательное слово, хвост положительный; they для nobody."),
        ],
    ),
]
