...
A2 = [
    module(
        ...
        [
            mc("Выберите время глагола: This week we ___ late because of a deadline.", ["stay", "are staying", "stays"], "are staying", "This week + временная ситуация."),
            fill("Вставьте нужную форму (boil): Water ___ at 100°C. (boil)", "boils", "Научный факт — Simple."),
            ...
            fill("Вставьте нужную форму (know): He ___ the answer, he just needs time. (know)", "knows", "Know не ставят в Continuous."),
            mc("Выберите нужную форму (привычка): On Sundays she ___ her grandparents. (привычка)", ["visits", "is visiting", "visit"], "visits", "Регулярное действие — Simple + -s."),
        ],
    ),
    module(
        "past-continuous",
        ...
        [
            ...
            fill("Вставьте нужную форму (write): He ___ an email when the client called. (write)", "was writing", "Прерванный процесс."),
            mc("Выберите нужную форму (законченный факт): Yesterday I ___ the whole series. (законченный факт)", ["was watching", "watched", "were watching"], "watched", "Без точки-процесса — Past Simple."),
        ],
    ),
    module(
        ...
        [
            fill("Вставьте нужную форму (already + speak, Present Perfect): I ___ to the manager. (already + speak, Present Perfect)", "have already spoken", "Speak — spoke — spoken; already перед V3.", ["I've already spoken"]),
            mc("Выберите форму Present Perfect: Has she ___ the email yet?", ["wrote", "written", "write"], "written", "После has — V3."),
            ...
            fill("Вставьте вспомогательный глагол: ___ he arrived yet?", "Has", "He + Has в вопросе."),
            mc("Выберите нужную форму (дата): I ___ Rome in 2018. (дата)", ["have visited", "visited", "am visiting"], "visited", "Год — Past Simple, не Present Perfect."),
        ],
    ),
    module(
        "will-vs-going-to",
        ...
        [
            fill("Вставьте нужную форму (примета): Look at the time! We ___ miss the train. (примета)", "are going to", "Опоздание уже видно — going to.", ["'re going to"]),
            mc("Выберите модальный глагол (will/would): I forgot sugar. I ___ buy some on the way.", ["am going to", "will", "going to"], "will", "Решение возникло только что."),
            ...
            fill("Вставьте модальный глагол: I promise I ___ be late. (отрицание)", "won't", "Обещание — will/won't.", ["will not"]),
            mc("Выберите will или going to: We've already booked the cabin. We ___ there in August.", ["will stay", "are going to stay", "stay"], "are going to stay", "Бронь = заранее принятый план."),
        ],
    ),
    module(
        "comparatives",
        ...
        [
            fill("Вставьте нужную форму (dark): The evenings are getting ___. (dark)", "darker", "Один слог + -er."),
            mc("Выберите сравнительную степень: His explanation was ___ than the textbook.", ["clearer", "more clearer", "clear more"], "clearer", "Clear берёт -er."),
            ...
            fill("Вставьте нужную форму (bad): Winter here is ___ than on the coast. (bad)", "worse", "Bad → worse."),
            mc("Выберите сравнительную степень: Online tickets are ___ paper ones.", ["more convenient than", "conveniencier than", "more convenient as"], "more convenient than", "Длинное прилагательное + than."),
        ],
    ),
    module(
        "superlatives",
    ...
    module(
        ...
        [
            ...
            fill("Вставьте quantifier (some/any/much…): How ___ chairs do we need?", "many", "Chairs исчисляемые — many."),
            mc("Your ___ is by the lift.", ["luggages", "luggage", "a luggages"], "luggage", "Luggage без -s."),
        ],
        [
            fill("Выберите quantifier: How ___ milk is left?", "much", "Milk неисчисляемое — much."),
            mc("Выберите исчисляемость / quantifier: He has a lot of ___ to do this weekend.", ["homeworks", "homework", "a homework"], "homework", "Homework неисчисляемое."),
            ...
            fill("Вставьте quantifier (some/any/much…): There isn't ___ bread.", "any", "Отрицание + неисчисляемое — any (или much).", ["much"]),
            mc("Выберите исчисляемость / quantifier: She has long dark ___.", ["hairs", "hair", "a hairs"], "hair", "Волосы на голове обычно hair без -s."),
        ],
    ),
    module(
        "quantifiers-a2",
        ...
        [
            fill("Вставьте quantifier (some/any/much…): Would you like ___ water?", "some", "Вежливое предложение — some.", ["a little"]),
            mc("Выберите quantifier (some/any/much…): There is ___ noise from the road, but I can work.", ["a few", "a little", "few"], "a little", "Noise неисчисляемое; шум есть, но терпимо."),
            ...
            fill("Вставьте quantifier (some/any/much…): ___ people came, so we cancelled the tour. (почти никто)", "Few", "Few без a = почти никто."),
            mc("Выберите quantifier (some/any/much…): There isn't ___ time before boarding.", ["many", "much", "a few"], "much", "Time неисчисляемое — much."),
        ],
    ),
    module(
        ...
        [
            fill("Вставьте модальный глагол should: You ___ drink more water. (совет)", "should", "Should + V1."),
            mc("Выберите конструкцию have to: Last night I ___ stay until closing.", ["must", "had to", "should to"], "had to", "Прошедшая внешняя обязанность — had to."),
            ...
            fill("Вставьте конструкцию have to: We ___ show ID at the gate. (внешняя обязанность)", "have to", "We have to + V1."),
            mc("Выберите модальный глагол must: Guests ___ smoke in the rooms. It's forbidden.", ["don't have to", "mustn't", "should"], "mustn't", "Forbidden = mustn't."),
        ],
    ),
    module(
        ...
        [
            ...
            xf("Составьте First Conditional (If + Present, will): she / miss / the bus / she / not leave / now", "If she doesn't leave now, she will miss the bus.", "If + Present, will.", ["If she does not leave now, she will miss the bus", "She will miss the bus if she doesn't leave now"]),
        ...
        [
            fill("Вставьте форму to be: If the battery ___ low, the phone shuts down. (be)", "is", "Zero: факт об устройстве."),
            mc("Выберите форму в условном предложении: We'll cancel the picnic if it ___ .", ["will rain", "rains", "rained"], "rains", "If + Present в First."),
            ...
            xf("Составьте Zero Conditional (If + Present, Present): ice / float / you / drop / it / in water", "If you drop ice in water, it floats.", "If + Present, Present.", ["If you drop it in water, ice floats"]),
            fill("Вставьте модальный глагол (will/would): If they offer me the shift, I ___ take it. (will)", "will", "Главная часть First — will + V1.", ["'ll"]),
            mc("Выберите форму в условном предложении: ___ you mix red and blue, you get purple.", ["If", "Unless", "Will"], "If", "Zero-факт — If + Present, Present."),
        ],
    ),
    module(
        ...
        [
            fill("Вставьте вопросительное / относительное слово: Students ___ miss the quiz take it on Friday.", "who", "Люди + сразу глагол — who/that.", ["that"]),
            mc("Выберите вопросительное / относительное слово: The tram ___ goes to the stadium is the 12.", ["who", "which", "where"], "which", "Tram — вещь."),
            ...
            fill("Вставьте вопросительное / относительное слово: Is this the street ___ the market is?", "where", "Место — where."),
            mc("Выберите вопросительное / относительное слово: The people ___ I invited are late.", ["which", "who", "where"], "who", "People — люди; who можно и опустить, но из вариантов верный who."),
        ],
    ),
    module(
        "used-to",
        ...
        [
            fill("Вставьте предлог: They used ___ keep bees on the roof.", "to", "used to + V1."),
            mc("Выберите конструкцию used to: She ___ a lot, but she sold the piano.", ["used to practise", "is used to practise", "use to practise"], "used to practise", "Законченная привычка — used to + V1."),
            ...
            fill("Вставьте used to: There ___ to be a fountain here.", "used", "There used to be."),
            mc("Выберите used to: Don't worry, you'll ___ the noise.", ["used to", "get used to", "use to"], "get used to", "Процесс привыкания — get used to."),
        ],
    ),
    module(
        ...
        [
            fill("Вставьте форму to be: The chairs ___ moved yesterday. (be)", "were", "Множественное + Past Passive."),
            mc("Выберите форму to be: Breakfast ___ served until 10.", ["is", "was being", "has"], "is", "Регулярное правило отеля — Present Passive."),
            ...
            fill("Вставьте форму to be: English ___ taught at that school. (отрицание, Present Passive)", "isn't", "Present Passive negative: isn't + V3.", ["is not"]),
            mc("Выберите форму to be: The bridge ___ damaged in the storm.", ["were", "was", "is being"], "was", "Один мост + прошедшее событие."),
        ],
    ),
    module(
        ...
        [
            fill("Вставьте нужную форму (обычно): They are ___ at home in the evening. (обычно)", "usually", "После are — частота."),
            mc("Выберите наречие: I could ___ see the sign in the fog.", ["hard", "hardly", "lately"], "hardly", "Hardly = почти не."),
            ...
            fill("Вставьте нужную форму (good → наречие): The team played ___ yesterday. (good → наречие)", "well", "Good → well."),
            mc("Выберите наречие: Please arrive ___. The briefing starts at 9 sharp.", ["lately", "early", "hardly"], "early", "Early — наречие без -ly."),
        ],
    ),
]
