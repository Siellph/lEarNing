...
B2 = [
    module(
        ...
        [
            ...
            fill("Вставьте форму результата (wouldn't be): If we had booked earlier, we ___ on the waiting list now.", "wouldn't be", "Mixed: прошлое условие → нынешнее состояние; wouldn't be + …", ["would not be"]),
            ...
            fill("Вставьте Past Perfect: If you ___ me the brief, I wouldn't be improvising on stage. (send)", "had sent", "Mixed: прошлое условие — Past Perfect (had + V3)."),
    ...
    module(
        ...
        [
            fill("Вставьте инфинитив: He is thought ___ negotiating with two publishers.", "to be", "Одновременный процесс — простой инфинитив to be + V-ing."),
    ...
    module(
        ...
        [
            ...
            fill("Вставьте Past Perfect Continuous: They ___ waiting forty minutes when the shuttle arrived.", "had been", "Длительность до прошлой точки — had been + V-ing."),
