...
C2 = [
    module(
        ...
        [
            fill("___ was the intern who froze the wrong branch. (it)", "It", "It-cleft."),
            mc("A spare impeller sat in the locker. ___ impeller later saved the crossing.", ["A", "That", "There"], "That", "Повтор как данное: that + noun."),
            ...
            fill("There ___ a sandbar just east of the marker. (be)", "is", "There is + новое."),
    ...
    module(
        ...
        [
            fill("She has ___ three fellowships, so the rumour is stale. (decline)", "declined", "Опыт/серия с нынешним выводом."),
            mc("Every Friday the siren ___ mark the pour. (narrative habit)", ["used", "would", "has"], "would", "Повтор действия в заданном прошлом."),
            ...
            fill("The emulsion ___ smelling odd this morning. (be)", "is", "Временный признак в Progressive."),
    ...
    module(
        ...
        [
            fill("The assay ___ at 06:40. (commence / past, protocol)", "commenced", "Протокольный commence."),
            ...
            fill("Sufficient is the formal twin of ___.", "enough", "Пара sufficient / enough."),
    ...
    module(
        ...
        [
            fill("We could have waited for slack water. We did ___.", "not", "Эллипсис глагольной группы."),
            mc("Choose the contrast marker.", ["moreover", "in contrast", "likewise"], "in contrast", "Противопоставление, не добавление."),
            xf("Уточните this: Fog delayed us. This was annoying. → This ___ wrecked the drone window.", "This delay wrecked the drone window.", "This + noun."),
            ...
            fill("Editorial flagged the clause. Legal flagged ___ too.", "it", "It держит clause."),
    ...
    module(
        ...
        [
            fill("___ the foundry will close — rumour, no named source. (reportedly)", "Reportedly", "Reportedly без источника."),
            mc("I ___ they have withdrawn. (inference from signals)", ["know", "gather", "swear"], "gather", "Gather = вывод издалека."),
            ...
            fill("The skipper ___ to have ignored the second beacon. (seem)", "seems", "Seems to have + V3."),
    ...
    module(
        ...
        [
            ...
            xf("Heavy shift: We sent the entire unredacted correspondence from March to legal.", "We sent to legal the entire unredacted correspondence from March.", "Тяжёлый NP после to legal."),
        ...
        [
            fill("The washer is ___ failed. (what)", "what", "Reverse wh-cleft: NP is what + verb."),
            ...
            fill("She attributed ___ fatigue the series of mislabels in aisle C. (to)", "to", "Attribute to + heavy NP справа."),
    ...
    module(
        ...
        [
            fill("___ the emulsion had already split. (half)", "Half", "Half the + noun."),
            mc("She is ___ the skipper in a cross-wind.", ["very", "quite", "such"], "quite", "Quite the + noun."),
            ...
            fill("Any leak ___ abort the dive. (will)", "will", "Any в утверждении = даже один."),
            mc("What little time we had ___ in the lock.", ["vanish", "vanished", "vanishes yesterday"], "vanished", "What little + noun + Past в рассказе."),
        ],
    ),
    module(
        ...
        [
            ...
            xf("Raising: It is likely that she will decline.", "She is likely to decline.", "Likely + to."),
        ...
        [
            fill("She is busy ___ the stills. (relabel)", "relabelling", "Busy + -ing.", ["relabeling"]),
            mc("The mix proved ___ bounced too hot.", ["it was", "to have been", "being"], "to have been", "Prove + raising + perfect infinitive."),
            xf("Extraposition: To freeze the branch before legal signed was a mistake.", "It was a mistake to freeze the branch before legal signed.", "It + be + noun + to."),
            ...
            fill("We told her ___ wait for slack water. (to)", "to", "Object control: tell somebody to."),
            mc("They persuaded the skipper ___ wait.", ["that", "to", "of"], "to", "Persuade somebody to."),
        ],
    ),
]
