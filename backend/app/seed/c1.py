...
C1 = [
    module(
        ...
        [
            fill("___ it not for the spare impeller, we would have drifted. (be)", "Were", "Were it not for."),
            mc("Such ___ the heat that the wax slumped.", ["was", "were", "did"], "was", "Such was + noun."),
            ...
            fill("Not since the 1978 storm ___ the harbour wall been rebuilt. (have)", "has", "Not since + инверсия: has + subject."),
            mc("Had the samples ___ frozen, the assay would have failed.", ["not been", "been not", "not be"], "not been", "Had + subject + not been."),
        ],
    ),
    module(
        "fronting-emphasis",
        ...
        [
            fill("___ to whether the lease renews, legal is silent. (as)", "As", "As to whether."),
            ...
            fill("Tired she ___, she still recut the trailer. (be / past)", "was", "Предикатив Tired спереди."),
            mc("Into the inlet ___ the pilot skiff.", ["did slide", "slid", "slide"], "slid", "Полная инверсия движения: into… slid + NP."),
        ],
    ),
    module(
        ...
        [
            fill("It is crucial that the samples ___ labelled tonight. (be)", "be", "Be + V3 в пассиве."),
            mc("Far ___ it from me to delay the launch.", ["is", "be", "was"], "be", "Формула Far be it from me."),
            xf("Требование: She must attend. → They requested that…", "They requested that she attend.", "That + базовая форма."),
            ...
            fill("Were she ___ resign, the deputy would step in. (to)", "to", "Were she to + infinitive."),
            mc("He suggested that the paragraph ___ deleted.", ["is", "be", "being"], "be", "Suggest в значении рекомендации + subjunctive."),
        ],
    ),
    module(
        "impersonal-passive",
        ...
        [
            fill("It has been suggested ___ we split the consignment. (that)", "that", "It + passive + that."),
            mc("___ are believed to have been two unlogged dives.", ["It", "There", "They"], "There", "There are believed to have been."),
            ...
            fill("The deputy is thought ___ acting chair until June. (be)", "to be", "Одновременная роль — простой инфинитив."),
            mc("It was estimated that the repair ___ six weeks.", ["to last", "would last", "lasting"], "would last", "После that нужна полная клауза, не инфинитив."),
        ],
    ),
    module(
        "hedging-modality",
        ...
        [
            fill("There ___ to be a second leak behind the lining. (appear)", "appears", "There appears to be."),
            mc("The figures would ___ to suggest a seasonal dip.", ["appear", "must", "tend that"], "appear", "Would appear to suggest — дистанцирование."),
            ...
            fill("He might ___ have missed the only marked channel. (conceivably)", "conceivably", "Might conceivably + have + V3."),
            mc("___ possible reading is that the log was backfilled.", ["It", "One", "There"], "One", "One possible reading is…"),
        ],
    ),
    module(
        "nominalization",
        ...
        [
            fill("Her ___ on a paper trail delayed payment. (insist)", "insistence", "Insistence on."),
            ...
            fill("They failed to notify us → their ___ to notify us. (fail)", "failure", "Failure to."),
    ...
    module(
        ...
        [
            fill("I can't read the log. — ___ can the intern.", "Neither", "Neither can + subject."),
            mc("So ___ I — если исходная фраза They have finished.", ["do", "have", "did"], "have", "Повторяем have."),
            ...
            fill("Keep the dry plates; recycle the warped ___.", "ones", "Ones = plates."),
            mc("He said he would override the lock, and he ___.", ["did so", "so did", "did it so"], "did so", "Do so замещает override the lock."),
        ],
    ),
    module(
        ...
        [
            fill("___ you hold a dated pass, you cannot board. (unless)", "Unless", "Unless + положительное условие."),
            mc("Were it not ___ the sandbar, the channel would be obvious.", ["for", "to", "that"], "for", "Were it not for."),
            ...
            fill("We will film on the wall ___ condition that the wind drops. (on)", "on", "On condition that."),
            fill("Suppose the generator ___ — which bank do we switch to? (fail / open plan)", "fails", "Открытый рабочий сценарий: suppose + Present Simple."),
        ],
    ),
    module(
        ...
        [
            fill("The refusal of the foundry ___ honour the invoice delayed parts. (to)", "to", "Refusal to + infinitive."),
            mc("those three ___ objections", ["well argued", "well-argued", "well-argue"], "well-argued", "Дефис у составного премодификатора."),
            ...
            fill("The accuracy of the tables issued in March ___ now in doubt. (be)", "is", "Голова accuracy."),
            mc("the samples ___ in aisle C", ["storing", "stored", "store"], "stored", "Пассивный постмодификатор."),
        ],
    ),
    module(
        ...
        [
            fill("He warned us ___ crossing after dusk. (against)", "against", "Warn against -ing."),
            mc("She explained ___ the surveyor.", ["the sag to", "to the sag", "the surveyor the sag"], "the sag to", "Explain something to somebody — в опции «the sag to»."),
            xf("Blame: They said the washer caused the failure. → They blamed the failure…", "They blamed the failure on the washer.", "Blame something on somebody/something."),
            ...
            fill("She refused ___ countersign the minutes. (to)", "to", "Refuse to."),
            mc("He reminded us ___ the dive before changing tanks.", ["logging", "to log", "of log"], "to log", "Remind somebody to do."),
        ],
    ),
]
